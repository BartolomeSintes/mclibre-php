<?php
/**
 * Tabla con casillas de verificación (Resultado 1) - foreach_2_1_2.php
 *
...
if ($numeroOk) {
    ...
    print "<form action=\"foreach_2_1_3.php\" method=\"get\">\n";
...
<p><a href="foreach_2_1_1.html">Volver al formulario.</a></p>
