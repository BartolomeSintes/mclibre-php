<?php
/**
 * Tabla con casillas de verificación (Resultado 2) - foreach_1_1_3.php
 *
...
<head>
  <meta charset="utf-8" />
  <title>Tabla de una fila con casillas de verificación (Resultado 2). foreach (1).
...
// dibujar la tabla
if ($numeroOk) {
    print "<p><a href=\"foreach_1_1_2.php?numero=$numero\">Volver a la tabla</a></p>\n";
}

?>

<p><a href="foreach_1_1_1.html">Volver al formulario inicial.</a></p>
