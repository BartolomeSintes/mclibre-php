...
<html lang="es">
  ...
  <body>
    ...
    <form action="for_2_2_2.php" method="get">
      <p>Escriba el tamaño de cada segmento (4 &lt; tamaño &le; 8) y el número de
        segmentos (1 &lt; franjas &le; 6) y dibujaré esos segmentos.</p>
