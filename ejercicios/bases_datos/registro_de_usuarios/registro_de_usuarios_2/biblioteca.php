...
if ($dbMotor == MYSQL) {
    ...
    $dbDb       = "/tmp/mclibre/mclibre_registrousuarios_2.sqlite";  // Nombre de la base de datos
...
<head>
  ...
  <title>www.mclibre.org - Registro de usuarios 2 - $texto</title>
...
<ul>\n";
    if ($menu == MENU_PRINCIPAL) {
        print "  <li><a href=\"conectar1.php\">Conectarse</a></li>";
