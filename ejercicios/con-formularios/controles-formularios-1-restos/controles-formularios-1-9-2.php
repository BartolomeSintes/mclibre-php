...
print "       width=\"" . $ancho + 2 * $grosor . "px\" height=\"" . $ancho + 2 * $grosor . "px\">\n";
print "    <rect fill=\"white\" stroke=\"black\"\n";
print "          stroke-width=\"$grosor\" " . "x=\"" . $grosor / 2 . "\" y=\"" . $grosor / 2 . "\"\n";
print "          width=\"" . $ancho + $grosor . "\" height=\"" . $ancho + $grosor . "\" />\n";
print "  </svg>\n";
print "\n";
?>
