<?php
/**
 * Tablas de colores (Resultado) - for-3-7-hsl-2.php
 *
...
if ($numeroOk) {
    ...
    for ($k = 0; $k < $numero; $k++) {
        ...
        for ($i = 0; $i < $numero; $i++) {
            ...
            for ($j = 0; $j < $numero; $j++) {
                $rk = round($k * $paso);
                $ri = round($i * $paso / 255 * 100);
                $rj = round($j * $paso / 255 * 100);
                print "      <td style=\"background-color:hsl($rk $ri% $rj%)\" title=\"H:$rk S:$ri% L:$rj%\"></td>\n";
            }
            print "    </tr>\n";
        }
        print "  </table>\n";
...
?>
  <p><a href="for-3-7-hsl-1.php">Volver al formulario.</a></p>
