...
print "         viewBox=\" -10 -10 " . $separacion * $numero - $separacion / 2 . " " . $longitud + 20 . "\"\n";
print "         style=\"border: black 1px solid\">\n";
for ($i = 0; $i < $numero; $i++) {
    print "      <line x1=\"" . $separacion * ($numero - 1) / 2 . "\" y1=\"0\" ";
    print "x2=\"" . $i * $separacion . "\" y2=\"$longitud\" stroke=\"blue\" stroke-width=\"1\" />\n";
}
print "    </svg>\n";
print "  </p>\n";
print "\n";
