...
if ($year % 400 == 0) {
    ...
    print "  <p>$year no es un año bisiesto porque es múltiplo de 100 sin ser múltiplo de 400.</p>\n";
} elseif ($year % 4 == 0) {
    print "  <p>$year es un año bisiesto porque es múltiplo de 4 sin ser múltiplo de 100.</p>\n";
} else {
