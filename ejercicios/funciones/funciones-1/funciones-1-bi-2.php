<?php
/**
 * Convertidor de distancias (1) Con biblioteca - funciones-1-2.php
 *
...
<?php
include "funciones-1-bi-biblioteca.php";
...
?>
  <p><a href="funciones-1-bi-1.php">Volver al formulario.</a></p>
