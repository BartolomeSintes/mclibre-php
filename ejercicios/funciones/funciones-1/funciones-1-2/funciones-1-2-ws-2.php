<?php
/**
 * Convertidor de distancias (2) Servicio web - funciones-1-2-2.php
 *
...
<head>
  <meta charset="utf-8">
  <title>
    Convertidor de distancias (2) Servicio web (Resultado).
...
<body>
  <h1>Convertidor de distancias (2) Servicio web (Resultado)</h1>
...
if ($numeroOk && $inicialOk && $finalOk) {
    ...
    $respuesta = file_get_contents("{$camino}funciones-1-2-ws.php?$consulta");
    print "  <p>$numero $inicial = $respuesta $final.</p>\n";
    print "\n";
}
?>
  <p><a href="funciones-1-2-ws-1.php">Volver al formulario.</a></p>
