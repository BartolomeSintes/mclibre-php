<?php
/**
 * Convertidor de distancias (3) JSON-RPC- funciones-1-3-2.php
 *
...
<head>
  <meta charset="utf-8">
  <title>
    Convertidor de distancias (3) JSON-RPC (Resultado).
...
if ($numeroOk && $inicialOk && $finalOk) {
    ...
    $respuesta = json_decode(file_get_contents("{$camino}funciones-1-3-rpc.php?$consulta"), true);
    if ($respuesta["id"] == $id) {
...
?>
  <p><a href="funciones-1-3-rpc-1.php">Volver al formulario.</a></p>
