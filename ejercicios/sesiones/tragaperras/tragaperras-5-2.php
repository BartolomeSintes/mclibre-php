<?php
/**
 * Tragaperras 5-2 - tragaperras-5-2.php
 *
...
if (!isset($_SESSION["monedas"], $_SESSION["fruta1"], $_SESSION["fruta2"], $_SESSION["fruta3"], $_SESSION["apuesta"], $_SESSION["premio"], $_SESSION["cara"])) {
    $_SESSION["monedas"] = 0;
...
if ($accion == "moneda") {
    ...
    $_SESSION["monedas"] += 1;
    // Se reinicia el premio
    $_SESSION["premio"] = 0;
    // Se reinicia la cara
    $_SESSION["cara"]   = "plain";
}

// Si se ha apostado y hay monedas insertadas ...
if ($accion == "apostar" && $_SESSION["monedas"] > 0) {
    // Se aumenta la cantidad apostada
    $_SESSION["apuesta"] += 1;
    // Se disminuye las monedas
    $_SESSION["monedas"] -= 1;
    // Se reinicia el premio
    $_SESSION["premio"] = 0;
    // Se reinicia la cara
...
if ($accion == "jugar" && $_SESSION["apuesta"] > 0) {
    ...
    // Si han salido dos cerezas
        ...
        ($_SESSION["fruta1"] == $cereza && $_SESSION["fruta2"] == $cereza)
