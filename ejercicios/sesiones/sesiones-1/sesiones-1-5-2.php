<?php
/**
 * Sesiones (1) 5-2 - sesiones-1-5-2.php
 *
...
// Si falta una de las variables de sesión, reiniciamos los valores
...
if ($siguiente == "Lanzar moneda") {
    ...
    if ($moneda == 1) {
        $_SESSION["puntosG"] += 1;
        $_SESSION["moneda"] = "<img src=\"img/monedas/a.svg\" alt=\"A\" width=\"100\" height=\"100\">";
    } else {
        $_SESSION["puntosM"] += 1;
        $_SESSION["moneda"] = "<img src=\"img/monedas/b.svg\" alt=\"B\" width=\"100\" height=\"100\">";
    }
