...
<head>
  ...
  <title>Calculos estadísticos 1 (Formulario). Repaso 2.
...
<body>
<h1>Calculos estadísticos 1 (Formulario)</h1>

<form action="calculos-estadisticos-1-a.php" method="get">
  <fieldset>
...
<p class="ultmod">Última modificación de esta página: 9 de abril de 2009</p>
