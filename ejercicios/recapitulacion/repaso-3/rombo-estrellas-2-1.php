...
<head>
  ...
  <title>Rombo de estrellas 2 (Formulario). Repaso (2).
...
<form action="rombo-estrellas-2.php" method="get">
  <fieldset>
    <legend>Formulario</legend>
    <p>Escriba el alto (0 &lt; alto &le; 30) y mostraré un rombo de estrellas de
    ese tamaño.</p>
