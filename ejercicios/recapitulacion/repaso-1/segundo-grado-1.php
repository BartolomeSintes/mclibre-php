...
<form action="segundo-grado.php" method="get">
  <fieldset>
    <legend>Formulario</legend>

    <p>Dado la ecuación de segundo grado <span
    style="font-size: 200%">a.x<sup>2</sup> + b.x + c = 0</span>, escriba los
    valores de los tres coeficientes y resolveré la ecuación:</p>
