...
if (!$result) {
    ...
    if (!$result) {
        ...
        print "      <p>Marque las discusiones que quiera borrar. Tenga en "
            . "cuenta que al borrar una discusión se borrarán también las "
            . "intervenciones correspondientes.</p>\n";
        print "\n";
        print "      <table border=\"1\">\n";
        print "        <thead>\n";
        print "          <tr class=\"neg\">\n";
        print "            <th>Borrar</th>\n";
        print "            <th><a href=\"$_SERVER[PHP_SELF]?campo=autor&amp;orden=ASC\">"
