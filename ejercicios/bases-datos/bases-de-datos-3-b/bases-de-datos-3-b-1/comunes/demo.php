...
$cfg["registrosDemo"] = [
    [$cfg["dbUsuariosTabla"], [1, "usuario1", encripta("usuario1"), NIVEL_USUARIO_BASICO]],
    [$cfg["dbUsuariosTabla"], [2, "usuario2", encripta("usuario2"), NIVEL_USUARIO_BASICO]],
    [$cfg["dbUsuariosTabla"], [3, "admin1", encripta("admin1"), NIVEL_ADMINISTRADOR]],
