...
if ($hayRegistrosOk) {
    ...
    if (!$resultado) {
        ...
        print "            </th>\n";
        print "            <th>\n";
        print "              <button name=\"ordena\" value=\"registros ASC\" class=\"boton-invisible\">\n";
        print "                <img src=\"../../img/abajo.svg\" alt=\"A-Z\" title=\"A-Z\" width=\"15\" height=\"12\">\n";
        print "              </button>\n";
        print "              Número de registros\n";
        print "              <button name=\"ordena\" value=\"registros DESC\" class=\"boton-invisible\">\n";
        print "                <img src=\"../../img/arriba.svg\" alt=\"Z-A\" title=\"Z-A\" width=\"15\" height=\"12\">\n";
        print "              </button>\n";
        print "            </th>\n";
        print "          </tr>\n";
        ...
        foreach ($resultado as $registro) {
            ...
            print "          <td>$registro[registros]</td>\n";
            print "        </tr>\n";
        }
        print "      </table>\n";
        print "    </form>\n";
