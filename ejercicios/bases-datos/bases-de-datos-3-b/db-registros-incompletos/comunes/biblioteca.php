...
function cabecera($texto, $menu, $profundidadDirectorio)
{
    ...
    print "  <title>\n";
    print "    $texto. Registros incompletos. Bases de datos (3 B).\n";
    ...
    print "<body>\n";
    print "  <header>\n";
    print "    <h1>Registros incompletos - $texto</h1>\n";
    print "\n";
    print "    <nav>\n";
    print "      <ul>\n";
    if (!isset($_SESSION["conectado"])) {
        ...
        if ($menu == MENU_PRINCIPAL) {
            ...
            print "        <li><a href=\"incompletos-1.php\">Incompletos</a></li>\n";
        } else {
            print "        <li>Error en la selección de menú</li>\n";
        }
...
function pie()
{
    ...
    print "      <time datetime=\"2024-02-06\">6 de febrero de 2024</time>\n";
    print "    </p>\n";
    print "\n";
