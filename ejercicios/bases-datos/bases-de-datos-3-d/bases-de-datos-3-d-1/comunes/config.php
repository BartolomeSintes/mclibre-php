...
$cfg["sessionName"] = "mclibre-bases-de-datos-3-d-1";       // Nombre de sesión
...
$cfg["sqliteDatabase"] = "/tmp/mclibre-base-datos-3-d-1.sqlite";    // Ubicación de la base de datos

// Configuración para MySQL

$cfg["mysqlHost"]     = "localhost";                        // Nombre de host
$cfg["mysqlUser"]     = "mclibre_base_datos_3_d_1";         // Nombre de usuario
$cfg["mysqlPassword"] = "";                                 // Contraseña de usuario
$cfg["mysqlDatabase"] = "mclibre_base_datos_3_d_1";         // Nombre de la base de datos
