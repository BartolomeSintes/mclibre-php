...
function cabecera($texto, $menu)
{
    ...
    print "  <title>$texto. Bases de datos 3-1. Bases de datos (3). \n";
    print "    Ejercicios. PHP. Bartolomé Sintes Marco. www.mclibre.org</title>\n";
    print "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n";
    print "  <link rel=\"stylesheet\" type=\"text/css\" href=\"mclibre-php-proyectos.css.php\" "
...
function pie()
{
    ...
    print "      <time datetime=\"2018-12-03\">3 de diciembre de 2018</time>\n";
    print "    </p>\n";
    print "\n";
