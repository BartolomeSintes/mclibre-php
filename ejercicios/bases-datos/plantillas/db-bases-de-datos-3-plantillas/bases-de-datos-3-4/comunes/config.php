...
$cfg["sqliteDatabase"] = "/tmp/iaw-base-datos-3-4.sqlite";  // Ubicación de la base de datos

// Configuración para MySQL

$cfg["mysqlHost"]     = "mysql:host=localhost";             // Nombre de host
$cfg["mysqlUser"]     = "iaw_base_datos_3_4";           // Nombre de usuario
$cfg["mysqlPassword"] = "";                                 // Contraseña de usuario
$cfg["mysqlDatabase"] = "iaw_base_datos_3_4";           // Nombre de la base de datos
...
$cfg["sessionName"]      = "iaw-bases-de-datos-3-4";    // Nombre de sesión
