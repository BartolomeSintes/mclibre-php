<?php
/**
 * Identificación de usuarios (2) - Agenda (1) - comunes/config.php
 *
...
define("SQLITE_DATABASE", "/home/barto/mclibre/tmp/mclibre/identificacion-2-agenda-1.sqlite"); // Ubicación de la base de datos
